package com.ljc.search.service.impl;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.ljc.common.api.R;
import com.ljc.common.es.SkuEsModel;
import com.ljc.search.feign.ProductFeignService;
...
public class MallSearchServiceImpl implements IMallSearchService {
    ...
    public SearchResult search(SearchParam param) {
        ...
        try {
            //2、执行检索请求
            SearchResponse response = esRestClient.search(searchRequest, RequestOptions.DEFAULT.toBuilder().build());
...
//                SkuEsModel esModel = JSON.parseObject(sourceAsString, SkuEsModel.class);
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                R<AttrResponseVo> r = productFeignService.attrInfo(Long.parseLong(s[0]));
                if (r.getErrorCode() == 0) {
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        SearchRequest searchRequest = new SearchRequest(new String[]{"gulimall_product"},searchSourceBuilder);
